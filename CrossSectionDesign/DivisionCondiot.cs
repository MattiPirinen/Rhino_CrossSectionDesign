...
{
    class DivisionCondiot : Rhino.Display.DisplayConduit
    {
        public List<Brep> DisplayBreps { get; set; } = new List<Brep>();
        private Color[] _colors = new Color[] {Color.Blue, Color.Aquamarine};


        public DivisionCondiot(List<Brep> displayBreps)
        {
            DisplayBreps = DisplayBreps;
        }

        public DivisionCondiot()
        {
        }
