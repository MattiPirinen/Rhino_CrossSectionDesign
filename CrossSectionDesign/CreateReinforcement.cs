...
namespace CrossSectionDesign
{
    static class CreateReinforcement
    {
        ...
        public static Reinforcement[] CreateReinforcements(string mName,int diam)
        {
            ...
            Reinforcement[] reinfList = CreateReinfObjs(doc, objects, layerIndex,mName,diam);
            ...
            int diam)
        {
            ...
            foreach (ObjRef obj in objects)
            {
                ...
                {
                    Material = new SteelMaterial(mName),
                    BasePoint = point,
                    Diameter = diam
                };
                reinfList.Add(reinf);
